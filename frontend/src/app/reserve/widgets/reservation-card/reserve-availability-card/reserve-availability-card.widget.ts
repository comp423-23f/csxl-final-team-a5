...
@Component({
  selector: 'reserve-availability-card',
  templateUrl: './reserve-availability-card.widget.html',
  styleUrls: ['./reserve-availability-card.widget.css'],
  standalone: true,
  imports: [MatCardModule, MatListModule, CommonModule]
})
export class ReserveAvailibilityCard implements OnChanges {
